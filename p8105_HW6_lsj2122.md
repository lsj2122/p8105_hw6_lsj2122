...
```
    ...
    ## Warning: Removed 3372 rows containing non-finite values (`stat_density()`).
...
There are 67.44 NA values, due to negative precipitation values, and we
can see this distribution after we remove the NA values.
