...
which could be attributed to the occurance of large outliers withing the
bootstrap samples.
...
```
    ...
    ## Warning: Removed 3370 rows containing non-finite values (`stat_density()`).
...
left-skewed. There are 67.4 NA values, due to negative precipitation
